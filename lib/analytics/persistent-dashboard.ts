...
export function buildPersistentDashboard(input: {
  ...
  return {
    ...
    metrics: {
      ...
      medianPayment: input.summary.metrics.medianPayment,
      previousPeriodSpend: input.summary.metrics.previousPeriodSpend,
      previousPeriodPaymentCount: input.summary.metrics.previousPeriodPaymentCount,
      spendChangePercent: input.summary.metrics.spendChangePercent,
      budgetUsed: input.summary.metrics.budgetUsed,
