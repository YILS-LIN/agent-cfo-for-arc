...
export const completeTransactionIntentInputSchema = z.object({
  intentId: z.string().uuid(),
});
...
export type CompleteTransactionIntentInput = z.input<typeof completeTransactionIntentInputSchema>;
